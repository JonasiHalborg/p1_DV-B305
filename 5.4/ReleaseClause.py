...
def overallpotential3i1():
    ...
    fig.text(0.5, 0.035, "Gennemsnit", fontsize=9, ha='center')
    ...
    ax2.plot(grouped_overall + standard_overall, "b--", alpha=0.5)
    ax2.plot(grouped_overall - standard_overall, "b--", alpha=0.5)
    ax2.grid(True)
    ax2.legend(["Overall", "Standardafvigelsen"])

    ax3.plot(grouped_potential, "r.")
    ax3.plot(grouped_potential + standard_potentiale, "r--", alpha=0.5)
    ax3.plot(grouped_potential - standard_potentiale, "r--", alpha=0.5)
    ax3.grid(True)
