...
plt.axis([-0.5,15.5,0,30])
plt.grid(axis="y")
plt.xticks(rotation=45, horizontalalignment='right')
plt.title('Top Gennemsnitsudvikling af talenter - Internt i Klubber fra FIFA 15 og FIFA 20')
plt.ylabel('Gennemsnitsstigningen i overall')
